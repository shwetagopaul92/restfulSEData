...
meta <- data.frame(
  ...
  Description = c(paste0("Metadata RangedSummarizedExperiment shell for banovichSE"),
                  ...
                  paste0("Metadata SummarizedExperiment shell for the full 1.3 million neuron dataset from 10x genomics"),
  ...
  RDataClass = c(rep("RangedSummarizedExperiment", 3), "SummarizedExperiment", "GRanges", "RangedSummarizedExperiment", "DataFrame"),
